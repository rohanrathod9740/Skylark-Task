...
sources. Currently, this requires: 
...
The Challenge 
Business data is messy. A founder asks "How's our pipeline looking for energy sector this 
quarter?" and someone needs to interpret that query, find relevant data across multiple boards, 
clean it, and provide meaningful insights 
Your Task 
Build an AI agent that can answer founder-level business intelligence queries by integrating with 
monday.com boards containing work orders and deals data. 
Sample Data 
You will receive two CSV files to import into monday.com: 
1. Work Orders - Project execution data 
2. Deals - Sales pipeline data 
P.S - Import these into monday.com as separate boards. Set up appropriate column types and 
...
How you interpret and implement this is up to you. Document your interpretation in your 
Decision Log. 
Integration Requirements 
Monday.com — Read only 
● Read: All data from both boards (Work Orders and Deals) 
● Use MCP or API — your choice 
● Important: Do not hardcode CSV data. Your agent must query monday.com 
dynamically. 
Deliverables 
...
3. Source Code 
● ZIP file 
● README with architecture overview and setup instructions for monday.com 
configuration 
Technical Expectations 
1. Conversational Interface: The user will interact with your agent conversationally, 
handle that to the best of your (agents') ability 
2. Monday.com Integration: Via MCP or API as specified above 
3. Error Handling: Graceful handling of data quality issues and API failures 
4. Tech Stack: Your choice — justify your decisions in the Decision Log 
Timeline 
6 hours 
Questions? 
If you have clarifying questions, document your assumptions and proceed. Part of the evaluation 
is seeing how you handle ambiguity and make decisions with incomplete information. 
Good luck! 
File Downloads 
Deal funnel Data.xlsx– pdf upload 
Work_Order_Tracker Data.xlsx
Submission Link – pdf upload 
https://forms.gle/aowDNBNUZD2hX6JJ8
